...
var Main = function (_React$Component) {
  ...
  _createClass(Main, [{
    ...
    value: function componentDidMount() {
      ...
      _axios2.default.get('/student') //got to local host/uri to see what's coming from route
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { id: 'app' },
        _react2.default.createElement(_StudentList2.default, { props: this.state.students })
      )
...
var StudentList = function StudentList(props) {
  return _react2.default.createElement(
    'ul',
    null,
    undefined.state.students.map(function (student) {
      return _react2.default.createElement(
        'li',
        { key: student.id },
        student.firstName,
